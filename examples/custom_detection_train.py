...
trainer.setTrainConfig(object_names_array=["person", "light_motor_vehicle", "heavy_motor_vehicle"], batch_size=4, num_experiments=200, train_from_pretrained_model="pretrained-yolov3.h5")
